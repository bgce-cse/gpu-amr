...
inline double wrap_periodic(double a, double lo, double hi)
{
...
{
    return [init_func, vx, vy, x_min, x_max, y_min, y_max, periodic]
           (double x, double y, double t)
    {
        ...
        if (periodic)
        {
            x0 = wrap_periodic(x0, x_min, x_max);
            y0 = wrap_periodic(y0, y_min, y_max);
        }
